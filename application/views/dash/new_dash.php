...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" style="display: block; height: 486px; width: 1152px;" width="2304" height="972"></canvas>
    ...
    <script src="Dashboard%20Template%20for%20Bootstrap_files/jquery-3.js"></script>
    <script>
        window.jQuery || document.write('<script src="../../assets/js/vendor/jquery-slim.min.js"><\/script>')
    </script>
    <script src="Dashboard%20Template%20for%20Bootstrap_files/popper.js"></script>
    <script src="Dashboard%20Template%20for%20Bootstrap_files/bootstrap.js"></script>

    <!-- Icons -->
    <script src="Dashboard%20Template%20for%20Bootstrap_files/feather.js"></script>
    <script>
        feather.replace()
    </script>

    <!-- Graphs -->
    <script src="Dashboard%20Template%20for%20Bootstrap_files/Chart.js"></script>
    <script>
